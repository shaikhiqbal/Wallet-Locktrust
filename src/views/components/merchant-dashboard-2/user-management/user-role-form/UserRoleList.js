...
// ** Reactstrap Imports
import { Card, CardHeader, CardTitle, CardFooter, CardText, Input, Label, Row, Col, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem, Button } from 'reactstrap'
// ** Styles
...
const UserListRole = ({data=[],title="List"}) => {
  // ** State
  ...
  return (
    <Card>
      <CardHeader className='border-bottom'>
        <CardTitle tag='h4'>User Role List</CardTitle>
      </CardHeader>
