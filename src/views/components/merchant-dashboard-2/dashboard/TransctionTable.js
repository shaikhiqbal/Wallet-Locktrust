...
// ** Reactstrap Imports
import { Card, CardHeader, CardTitle, CardFooter, CardText, Input, Label, Row, Col, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem } from 'reactstrap'
// ** Styles
...
const TransctionTable = ({data=[],title="List"}) => {
  // ** State
